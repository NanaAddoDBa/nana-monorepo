import { RuleSuggestion } from "./expense.types";

export const CATEGORY_RULES: readonly RuleSuggestion[] = [
  {
...
/**
 * Pure rule engine function to suggest an expense category based on merchant name and description.
 */
