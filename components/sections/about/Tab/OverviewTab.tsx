      ...
      <div className="grid gap-6 xl:grid-cols-[1.5fr_1fr] xl:items-start">
        <div className="space-y-4 md:space-y-5">
          ...
          <div className="space-y-3">
            <h3 className="font-heading text-3xl leading-tight text-card-foreground md:text-4xl">
        ...
        <div className="grid gap-3 sm:grid-cols-3 xl:grid-cols-1">
          {aboutOverviewData.stats.map((stat) => (
            <Card
              key={stat.id}
              className="border-border/60 bg-secondary/30 shadow-none"
            >
              <CardContent className="p-4">
                <div className="space-y-1">
                  <p className="font-heading text-2xl text-card-foreground">
                    {stat.value}
                  </p>
